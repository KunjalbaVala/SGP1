...
# Command to start scriptpython .\detect_from_image_count_objects.py -m ssd_mobilenet_v2_320x320_coco17_tpu-8\saved_model -l .\data\mscoco_label_map.pbtxt -i .\test_images
#
